    ...
    <div className="flex flex-col relative w-full h-full min-h-screen">
      ...
      <div className="relative z-10 w-full">
        ...
        <section className="relative flex flex-col items-center justify-center min-h-[calc(100vh-56px)] text-center px-6 overflow-hidden">
          ...
          {/* <div className="relative z-10 flex flex-col items-center p-8 md:p-12 rounded-[2rem] bg-white/10 border border-white/10 backdrop-blur-md shadow-2xl max-w-3xl mx-auto"> */}
          <div className="relative z-10 flex flex-col items-center p-8 md:p-12 rounded-[2rem] bg-white/9.5 border border-white/10 backdrop-blur-sm shadow-xl max-w-3xl mx-auto">
            {/* Badge */}
